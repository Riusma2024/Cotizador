            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex bg-gray-100 p-1 rounded-lg">
                    <button
                        ...
                        className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === 'employees' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:text-gray-900'}`}
                    >
                        Empleados
                    </button>
                    <button
                        onClick={() => setActiveTab('reports')}
                        className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === 'reports' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:text-gray-900'}`}
                    >
                        Reportes
                    </button>
                </div>
            ...
            {activeTab === 'employees' ? (
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-blue-600 p-6 rounded-xl text-white shadow-lg shadow-blue-200 flex items-center justify-between">
                            <div>
                                <p className="text-blue-100 text-sm font-medium uppercase tracking-wider mb-1">Monto Total</p>
                                <h3 className="text-2xl font-bold">{formatCurrency(totalStats.total)}</h3>
                            </div>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex items-center justify-between">
                            <div>
                                <p className="text-gray-500 text-sm font-medium uppercase tracking-wider mb-1">Total Cotizaciones</p>
                                <h3 className="text-2xl font-bold text-gray-900">{totalStats.count}</h3>
                            </div>
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {filteredQuotes.map((quote) => (
                                    <tr key={quote.id} className="hover:bg-gray-50 transition-colors">
                                        <td className="px-6 py-4 font-bold text-blue-600">{quote.folio}</td>
                                        ...
                                        <td className="px-6 py-4 text-gray-900 font-medium">{quote.customer.name}</td>
                                        <td className="px-6 py-4">
                                            <span className="bg-gray-100 px-2 py-1 rounded text-xs text-gray-700 font-medium border border-gray-200">
                                                {quote.employeeName}
                                            </span>
                                        </td>
