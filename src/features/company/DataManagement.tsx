                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-100">
                    <div className="space-y-4">
                        <div className="bg-blue-50 p-4 rounded-lg">
                            ...
                            <p className="text-xs text-blue-700 mb-4">Descarga un archivo JSON con toda tu base de datos actual para respaldarla o compartirla.</p>
                            <button
                    ...
                    <div className="space-y-4">
                        <div className="bg-amber-50 p-4 rounded-lg">
                            ...
                            <p className="text-xs text-amber-700 mb-4">Carga un archivo de respaldo previo. <span className="font-bold underline">Esto sobrescribirá tus datos actuales</span>.</p>
