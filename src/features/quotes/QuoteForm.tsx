...
export const QuoteForm = () => {
    ...
    return (
        <div className="space-y-6">
                ...
                {id && (
                    <div className="flex gap-2">
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-200 text-blue-700 rounded-md hover:bg-blue-100 transition-colors"
                        >
                            <Download size={20} />
                            Descargar PDF
                        </button>
            ...
            {/* Hidden QuotePDF for printing/downloading */}
            ...
            >
                            ...
                            <input
                                ...
                                onChange={e => {
                                    ...
                                    if (existingCustomer) {
                                        ...
                                        // Si el ID actual ya pertenece a un cliente conocido, pero el nombre cambió a algo nuevo,
                                        // necesitamos un nuevo ID para no sobreescribir al cliente original.
                ...
                {/* Items */}
                <div className="bg-white shadow-sm rounded-lg border border-gray-200 p-4">
                    <h3 className="text-lg font-medium text-gray-900 mb-3">Partidas</h3>
                    <div className="space-y-3">
                        {formData.items.map((item) => {
                            ...
                            return (
                                <div key={item.id} className="flex gap-3 items-start p-3 bg-gray-50 rounded-lg border border-gray-100">
                                            ...
                                            <div className="col-span-3 flex gap-2">
                                                <div className="flex-1">
                                                    ...
                                                    <div className="flex gap-2">
                                                        ...
                                                        />
                                                        <select
                                                            className="w-24 px-1 py-1 border border-gray-300 rounded-md text-sm"
